...
export default async function CoinModerationCasePage({ params }: { params: Promise<{ caseId: string }> }) { const { caseId } = await params; return <CoinRouteContent path={`/moderation/coins/cases/${caseId}`} />; }
