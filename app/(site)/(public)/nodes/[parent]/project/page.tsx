import { NodeProjectContent } from "@/app/_components/pages/nodes-content";
...
export default async function NodeProjectPage({ params }: { params: Promise<{ parent: string }> }) { const { parent } = await params; return <NodeProjectContent path={`/nodes/${parent}/project`} />; }
