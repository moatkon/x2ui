...
export default async function UserFollowersPage({ params }: { params: Promise<{ userName: string }> }) { const { userName } = await params; return <UserContent path={`/users/${userName}/followers`} />; }
