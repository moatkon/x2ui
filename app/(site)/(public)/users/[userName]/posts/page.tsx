...
export default async function UserPostsPage({ params }: { params: Promise<{ userName: string }> }) { const { userName } = await params; return <UserContent path={`/users/${userName}/posts`} />; }
