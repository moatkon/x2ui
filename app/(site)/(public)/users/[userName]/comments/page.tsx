...
export default async function UserCommentsPage({ params }: { params: Promise<{ userName: string }> }) { const { userName } = await params; return <UserContent path={`/users/${userName}/comments`} />; }
