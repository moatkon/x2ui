...
export function AuthForm({ type, returnTo = "/" }: { type: AuthFormType; returnTo?: string }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      router.replace(type === "login" ? returnTo : type === "register" ? "/verify-email" : type === "reset" ? "/login" : "/verify-email/result");
      router.refresh();
    } catch (error) {
