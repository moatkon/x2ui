...
export function MobileNavigation() {
  const path = usePathname();
  return <details className="dropdown lg:hidden"><summary className="btn btn-ghost btn-square" aria-label="打开导航">☰</summary><ul className="menu dropdown-content z-30 mt-2 w-64 border-2 border-base-content/20 bg-base-100 p-2"><li className="menu-title">浏览 X2Post</li><NavigationLinks path={path} /><li className="menu-title mt-3">我的</li><li><Link href="/bookmarks">收藏</Link></li><li><Link href="/notifications">通知</Link></li><li><Link href="/settings/profile">设置</Link></li></ul></details>;
}
