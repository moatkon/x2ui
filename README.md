...
- API 文档入口为 `docs/api-reference.md`；字段级契约在 `docs/prototype-api-contracts.md`，页面/领域覆盖在 `docs/prototype-api-design.md`。
- `/api/v1/*` 提供按字段契约组织的 mock Route Handler，覆盖公开查询和主要写交互，并模拟游标、`Idempotency-Key`、`If-Match` 与标准错误结构。
